 ...
 */
#[no_mangle]
pub unsafe extern "C" fn speex_resampler_init(mut nb_channels: spx_uint32_t,
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn speex_resampler_init_frac(mut nb_channels:
                                                       spx_uint32_t,
                                                   mut ratio_num:
                                                       spx_uint32_t,
                                                   mut ratio_den:
 ...
 -> *mut SpeexResamplerState {
    ...
    if nb_channels == 0i32 as libc::c_uint ||
           ...
           ratio_den == 0i32 as libc::c_uint || quality > 10i32 ||
           quality < 0i32 {
        if !err.is_null() { *err = RESAMPLER_ERR_INVALID_ARG as libc::c_int }
        return 0 as *mut SpeexResamplerState
    } else {
        st =
            speex_alloc(::std::mem::size_of::<SpeexResamplerState>() as
        ...
        if st.is_null() {
            ...
            (*st).last_sample =
                speex_alloc((nb_channels as
                                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<spx_int32_t>()
                                                                 as
                                                                 libc::c_ulong)
            ...
            if !(*st).last_sample.is_null() {
                (*st).magic_samples =
                    speex_alloc((nb_channels as
                                     libc::c_ulong).wrapping_mul(::std::mem::size_of::<spx_uint32_t>()
                                                                     as
                                                                     libc::c_ulong)
                                    as libc::c_int) as *mut spx_uint32_t;
                if !(*st).magic_samples.is_null() {
                    ...
                    if !(*st).samp_frac_num.is_null() {
                        ...
                        speex_resampler_set_rate_frac(st, ratio_num,
                                                      ratio_den, in_rate,
                                                      out_rate);
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn speex_resampler_destroy(mut st:
                                                     *mut SpeexResamplerState)
 -> () {
...
unsafe extern "C" fn update_filter(mut st: *mut SpeexResamplerState)
 -> libc::c_int {
    ...
    if (*st).num_rate > (*st).den_rate {
        (*st).cutoff =
            quality_map[(*st).quality as usize].downsample_bandwidth *
                (*st).den_rate as libc::c_float /
                (*st).num_rate as libc::c_float;
        if _muldiv(&mut (*st).filt_len as *mut spx_uint32_t, (*st).filt_len,
                   (*st).num_rate, (*st).den_rate) !=
            ...
            (*st).filt_len =
                ((*st).filt_len.wrapping_sub(1i32 as libc::c_uint) &
                     !7i32 as
                         libc::c_uint).wrapping_add(8i32 as libc::c_uint);
        ...
        8258075665625361029 => {
            use_direct =
                ((*st).filt_len.wrapping_mul((*st).den_rate) <=
                     (*st).filt_len.wrapping_mul((*st).oversample).wrapping_add(8i32
                                                                                    as
                                                                                    libc::c_uint)
                     &&
                     (2147483647i32 as
                          libc::c_ulong).wrapping_div(::std::mem::size_of::<spx_word16_t>()
                                                          as
                                                          libc::c_ulong).wrapping_div((*st).den_rate
                                                                                          as
                                                                                          libc::c_ulong)
                         >= (*st).filt_len as libc::c_ulong) as libc::c_int;
            if 0 != use_direct {
                min_sinc_table_length =
                    (*st).filt_len.wrapping_mul((*st).den_rate);
                current_block = 14523784380283086299;
            } else if (2147483647i32 as
                           libc::c_ulong).wrapping_div(::std::mem::size_of::<spx_word16_t>()
                                                           as
                                                           libc::c_ulong).wrapping_sub(8i32
                                                                                           as
                                                                                           libc::c_ulong).wrapping_div((*st).oversample
                                                                                                                           as
                                                                                                                           libc::c_ulong)
            ...
            match current_block {
                ...
                _ => {
                    if (*st).sinc_table_length < min_sinc_table_length {
                        let mut sinc_table: *mut spx_word16_t =
                            speex_realloc((*st).sinc_table as
                                              *mut libc::c_void,
                                          (min_sinc_table_length as
                                               libc::c_ulong).wrapping_mul(::std::mem::size_of::<spx_word16_t>()
                                                                               as
                                                                               libc::c_ulong)
                                              as libc::c_int) as
                                *mut spx_word16_t;
                        ...
                        _ => {
                            if 0 != use_direct {
                                ...
                                while i < (*st).den_rate {
                                    ...
                                    while (j as libc::c_uint) < (*st).filt_len
                                          {
                                        *(*st).sinc_table.offset(i.wrapping_mul((*st).filt_len).wrapping_add(j
                                                                                                                 as
                                                                                                                 libc::c_uint)
                                                                     as isize)
                                            =
                                ...
                                i_0 = -4i32;
                                while i_0 <
                                          (*st).oversample.wrapping_mul((*st).filt_len).wrapping_add(4i32
                                                                                                         as
                                                                                                         libc::c_uint)
                                              as spx_int32_t {
                                    *(*st).sinc_table.offset((i_0 + 4i32) as
                                                                 isize) =
                                        sinc((*st).cutoff,
                                             i_0 as libc::c_float /
                                                 (*st).oversample as
                                                     libc::c_float -
                                                 (*st).filt_len.wrapping_div(2i32
                                                                                 as
                                                                                 libc::c_uint)
                                                     as libc::c_float,
                                ...
                                if (*st).quality > 8i32 {
                                    (*st).resampler_ptr =
                                        Some(resampler_basic_interpolate_double)
                                } else {
                                    (*st).resampler_ptr =
                                        Some(resampler_basic_interpolate_single)
                                }
                            }
                            min_alloc_size =
                                (*st).filt_len.wrapping_sub(1i32 as
                                                                libc::c_uint).wrapping_add((*st).buffer_size);
                            if min_alloc_size > (*st).mem_alloc_size {
                                ...
                                if (2147483647i32 as
                                        libc::c_ulong).wrapping_div(::std::mem::size_of::<spx_word16_t>()
                                                                        as
                                                                        libc::c_ulong).wrapping_div((*st).nb_channels
                                                                                                        as
                                                                                                        libc::c_ulong)
                                    ...
                                    if 0 == (*st).started {
                                        ...
                                        loop  {
                                            ...
                                            let mut olen: spx_uint32_t =
                                                old_length;
                                            olen =
                                                old_length.wrapping_add((2i32
                                                                             as
                                                                             libc::c_uint).wrapping_mul(*(*st).magic_samples.offset(i_2
                                                                                                                                        as
                                                                                                                                        isize)));
                                            j_0 =
                                                old_length.wrapping_sub(1i32
                                                                            as
                                                                            libc::c_uint).wrapping_add(*(*st).magic_samples.offset(i_2
                                                                                                                                       as
                                                                                                                                       isize));
                                            loop  {
                                                let fresh1 = j_0;
                                                ...
                                                *(*st).mem.offset(i_2.wrapping_mul((*st).mem_alloc_size).wrapping_add(j_0).wrapping_add(*(*st).magic_samples.offset(i_2
                                                                      ...
                                                                      as
                                                                      isize) =
                                                    *(*st).mem.offset(i_2.wrapping_mul(old_alloc_size).wrapping_add(j_0)
                                                                          as
                                                                          isize)
                                            }
                                            j_0 = 0i32 as spx_uint32_t;
                                            while j_0 <
                                                      *(*st).magic_samples.offset(i_2
                                                                                      as
                                                                                      isize)
                                                  {
                                            ...
                                            *(*st).magic_samples.offset(i_2 as
                                                                            isize)
                                                = 0i32 as spx_uint32_t;
                                            if (*st).filt_len > olen {
                                                j_0 = 0i32 as spx_uint32_t;
                                                while j_0 <
                                                          olen.wrapping_sub(1i32
                                                                                as
                                                                                libc::c_uint)
                                                      {
                                                ...
                                                *(*st).magic_samples.offset(i_2
                                                                                ...
                                                                                isize)
                                                    =
                                                    olen.wrapping_sub((*st).filt_len).wrapping_div(2i32
                                                                                                       as
                                                                                                       libc::c_uint);
                                                j_0 = 0i32 as spx_uint32_t;
                                                while j_0 <
                                        ...
                                        while i_3 < (*st).nb_channels {
                                            ...
                                            let mut old_magic: spx_uint32_t =
                                                *(*st).magic_samples.offset(i_3
                                                                                as
                                                                                isize);
                                            *(*st).magic_samples.offset(i_3 as
                                                                            isize)
                                                =
                                                old_length.wrapping_sub((*st).filt_len).wrapping_div(2i32
                                                                                                         as
                                                                                                         libc::c_uint);
                                            ...
                                            while j_1 <
                                                      (*st).filt_len.wrapping_sub(1i32
                                                                                      as
                                                                                      libc::c_uint).wrapping_add(*(*st).magic_samples.offset(i_3
                                                                                                                                                 as
                                                                                                                                                 isize)).wrapping_add(old_magic)
                                                  {
                                                *(*st).mem.offset(i_3.wrapping_mul((*st).mem_alloc_size).wrapping_add(j_1)
                                                                      as
                                                                      isize) =
                                                    *(*st).mem.offset(i_3.wrapping_mul((*st).mem_alloc_size).wrapping_add(j_1).wrapping_add(*(*st).magic_samples.offset(i_3
                                                                                                                                                                            as
                                                                                                                                                                            isize))
                                                                          as
                                                                          isize);
                                            ...
                                            *fresh3 =
                                                (*fresh3 as
                                                     libc::c_uint).wrapping_add(old_magic)
                                                    as spx_uint32_t as
                                                    spx_uint32_t;
                                            i_3 = i_3.wrapping_add(1)
                                        }
                                    }
                                    return RESAMPLER_ERR_SUCCESS as
                                               libc::c_int
                                }
                            }
                        }
...
unsafe extern "C" fn resampler_basic_zero(mut st: *mut SpeexResamplerState,
 ...
 -> libc::c_int {
    ...
    while !(last_sample >= *in_len as spx_int32_t ||
        ...
        *out.offset((out_stride * fresh4) as isize) = 0i32 as spx_word16_t;
        ...
        samp_frac_num =
            (samp_frac_num as
                 libc::c_uint).wrapping_add(frac_advance as libc::c_uint) as
                spx_uint32_t as spx_uint32_t;
        if !(samp_frac_num >= den_rate) { continue ; }
        samp_frac_num =
            (samp_frac_num as libc::c_uint).wrapping_sub(den_rate) as
                spx_uint32_t as spx_uint32_t;
        last_sample += 1
    }
 ...
 -> libc::c_int {
    ...
    while !(last_sample >= *in_len as spx_int32_t ||
        ...
        let offset: libc::c_int =
            samp_frac_num.wrapping_mul((*st).oversample).wrapping_div((*st).den_rate)
                as libc::c_int;
        let frac: spx_word16_t =
            samp_frac_num.wrapping_mul((*st).oversample).wrapping_rem((*st).den_rate)
                as libc::c_float / (*st).den_rate as libc::c_float;
        let mut interp: [spx_word16_t; 4] = [0.; 4];
        let mut j: libc::c_int = 0;
        let mut accum: [spx_word32_t; 4] =
            [0i32 as spx_word32_t, 0i32 as spx_word32_t, 0i32 as spx_word32_t,
        ...
        while j < N {
            ...
            accum[0usize] +=
                curr_in *
                    *(*st).sinc_table.offset((4i32 as
                                                  libc::c_uint).wrapping_add(((j
                                                                                   +
                                                                                   1i32)
                                                                                  as
                                                                                  libc::c_uint).wrapping_mul((*st).oversample)).wrapping_sub(offset
                                                                                                                                                 as
                                                                                                                                                 libc::c_uint).wrapping_sub(2i32
                                                                                                                                                                                as
                                                                                                                                                                                libc::c_uint)
                                                 as isize);
            accum[1usize] +=
        ...
        sum =
            interp[0usize] * accum[0usize] + interp[1usize] * accum[1usize] +
...
unsafe extern "C" fn cubic_coef(mut frac: spx_word16_t,
                                mut interp: *mut spx_word16_t) -> () {
    *interp.offset(0isize) =
        -0.16666999459266663f32 * frac +
            0.16666999459266663f32 * frac * frac * frac;
    *interp.offset(1isize) =
        frac + 0.5f32 * frac * frac - 0.5f32 * frac * frac * frac;
    *interp.offset(3isize) =
        -0.3333300054073334f32 * frac + 0.5f32 * frac * frac -
            0.16666999459266663f32 * frac * frac * frac;
    *interp.offset(2isize) =
        (1.0f64 - *interp.offset(0isize) as libc::c_double -
             *interp.offset(1isize) as libc::c_double -
             *interp.offset(3isize) as libc::c_double) as spx_word16_t;
}
unsafe extern "C" fn resampler_basic_interpolate_double(mut st:
                                                            *mut SpeexResamplerState,
                                                        mut channel_index:
                                                            spx_uint32_t,
                                                        mut in_0:
 ...
 -> libc::c_int {
    ...
    while !(last_sample >= *in_len as spx_int32_t ||
        ...
        cubic_coef(frac, interp.as_mut_ptr());
        sum =
            (interp[0usize] as libc::c_double * accum[0usize] +
                 interp[1usize] as libc::c_double * accum[1usize] +
                 interp[2usize] as libc::c_double * accum[2usize] +
                 interp[3usize] as libc::c_double * accum[3usize]) as
                spx_word32_t;
...
static mut kaiser12_table: [libc::c_double; 68] =
    unsafe {
        [0.99859849f64, 1.0f64, 0.99859849f64, 0.99440475f64, 0.98745105f64,
         ...
         0.81573067f64, 0.78710866f64, 0.75723148f64, 0.7262997f64,
         0.69451601f64, 0.66208321f64, 0.62920216f64, 0.59606986f64,
         0.56287762f64, 0.52980938f64, 0.49704014f64, 0.46473455f64,
         0.43304576f64, 0.40211431f64, 0.37206735f64, 0.343018f64,
         0.3150649f64, 0.28829195f64, 0.26276832f64, 0.23854851f64,
         0.21567274f64, 0.19416736f64, 0.17404546f64, 0.15530766f64,
         0.13794293999999999f64, 0.12192957f64, 0.10723616f64, 0.09382272f64,
         0.08164178f64, 0.0706395f64, 0.06075685f64, 0.05193064f64,
         0.04409466f64, 0.03718069f64, 0.03111947f64, 0.02584161f64,
         0.02127838f64, 0.0173625f64, 0.01402878f64, 0.01121463f64,
         0.00886058f64, 0.00691064f64, 0.00531256f64, 0.00401805f64,
         0.00298291f64, 0.00216702f64, 0.00153438f64, 0.00105297f64,
         0.00069463f64, 0.00043489f64, 0.00025272f64, 0.00013031f64,
         0.0000527734f64, 0.00001f64, 0.0f64]
    };
...
static mut kaiser10_table: [libc::c_double; 36] =
    unsafe {
        [0.99537781f64, 1.0f64, 0.99537781f64, 0.98162644f64, 0.95908712f64,
         ...
         0.5011968f64, 0.44221549f64, 0.38553619f64, 0.33194107f64,
         0.28205962f64, 0.23636152f64, 0.19515633f64, 0.15859932f64,
         0.1267028f64, 0.09935205f64, 0.07632451f64, 0.05731132f64,
         0.0419398f64, 0.02979584f64, 0.0204451f64, 0.01345224f64,
         0.00839739f64, 0.00488951f64, 0.00257636f64, 0.00115101f64,
         0.00035515f64, 0.0f64, 0.0f64]
    };
...
static mut kaiser8_table: [libc::c_double; 36] =
    unsafe {
        [0.99635258f64, 1.0f64, 0.99635258f64, 0.98548012f64, 0.96759014f64,
         ...
         0.58014482f64, 0.52566725f64, 0.47185369f64, 0.4194115f64,
         0.36897272f64, 0.32108304f64, 0.27619388f64, 0.23465776f64,
         0.1967267f64, 0.1625538f64, 0.13219758f64, 0.10562887f64,
         0.08273982f64, 0.06335451f64, 0.04724088f64, 0.03412321f64,
         0.0236949f64, 0.01563093f64, 0.00959968f64, 0.00527363f64,
         0.00233883f64, 0.0005f64, 0.0f64]
    };
...
static mut kaiser6_table: [libc::c_double; 36] =
    unsafe {
        [0.99733006f64, 1.0f64, 0.99733006f64, 0.98935595f64, 0.97618418f64,
         ...
         0.67172623f64, 0.62508937f64, 0.57774224f64, 0.53019925f64,
         0.48295561f64, 0.43647969f64, 0.39120616f64, 0.34752997f64,
         0.30580127f64, 0.26632152f64, 0.22934058f64, 0.19505503f64,
         0.16360756f64, 0.13508755f64, 0.10953262f64, 0.0869312f64,
         0.067226f64, 0.0503182f64, 0.03607231f64, 0.02432151f64,
         0.01487334f64, 0.00752f64, 0.0f64]
    };
unsafe extern "C" fn sinc(mut cutoff: libc::c_float, mut x: libc::c_float,
...
unsafe extern "C" fn compute_func(mut x: libc::c_float,
 ...
 -> libc::c_double {
    ...
    ind = floor(y as libc::c_double) as libc::c_int;
    frac = y - ind as libc::c_float;
    interp[3usize] =
        -0.1666666667f64 * frac as libc::c_double +
            0.1666666667f64 * (frac * frac * frac) as libc::c_double;
    interp[2usize] =
        frac as libc::c_double + 0.5f64 * (frac * frac) as libc::c_double -
            0.5f64 * (frac * frac * frac) as libc::c_double;
    interp[0usize] =
        -0.3333333333f64 * frac as libc::c_double +
            0.5f64 * (frac * frac) as libc::c_double -
            0.1666666667f64 * (frac * frac * frac) as libc::c_double;
    interp[1usize] =
        1.0f32 as libc::c_double - interp[3usize] - interp[2usize] -
            interp[0usize];
...
unsafe extern "C" fn resampler_basic_direct_single(mut st:
                                                       *mut SpeexResamplerState,
                                                   mut channel_index:
                                                       spx_uint32_t,
                                                   mut in_0:
 ...
 -> libc::c_int {
    ...
    while !(last_sample >= *in_len as spx_int32_t ||
                out_sample >= *out_len as spx_int32_t) {
        let mut sinct: *const spx_word16_t =
            &*sinc_table.offset(samp_frac_num.wrapping_mul(N as libc::c_uint)
                                    as isize) as *const spx_word16_t;
        let mut iptr: *const spx_word16_t =
            &*in_0.offset(last_sample as isize) as *const spx_word16_t;
        let mut j: libc::c_int = 0;
...
unsafe extern "C" fn resampler_basic_direct_double(mut st:
                                                       *mut SpeexResamplerState,
                                                   mut channel_index:
                                                       spx_uint32_t,
                                                   mut in_0:
 ...
 -> libc::c_int {
    ...
    while !(last_sample >= *in_len as spx_int32_t ||
        ...
        while j < N {
            accum[0usize] +=
                (*sinct.offset(j as isize) * *iptr.offset(j as isize)) as
                    libc::c_double;
            accum[1usize] +=
                (*sinct.offset((j + 1i32) as isize) *
                     *iptr.offset((j + 1i32) as isize)) as libc::c_double;
            accum[2usize] +=
                (*sinct.offset((j + 2i32) as isize) *
                     *iptr.offset((j + 2i32) as isize)) as libc::c_double;
            accum[3usize] +=
                (*sinct.offset((j + 3i32) as isize) *
                     *iptr.offset((j + 3i32) as isize)) as libc::c_double;
            j += 4i32
        }
...
unsafe extern "C" fn _muldiv(mut result: *mut spx_uint32_t,
                             mut value: spx_uint32_t, mut mul: spx_uint32_t,
                             mut div: spx_uint32_t) -> libc::c_int {
    if result.is_null() {
        _speex_fatal((*::std::mem::transmute::<&[u8; 25],
                                               &mut [libc::c_char; 25]>(b"assertion failed: result\x00")).as_mut_ptr(),
                     (*::std::mem::transmute::<&[u8; 11],
                                               &mut [libc::c_char; 11]>(b"resample.c\x00")).as_mut_ptr(),
                     594i32);
    }
    ...
    if remainder > 4294967295u32.wrapping_div(mul) ||
        ...
        *result =
            remainder.wrapping_mul(mul).wrapping_div(div).wrapping_add(major.wrapping_mul(mul));
...
unsafe extern "C" fn _speex_fatal(mut st: *const libc::c_char,
                                  mut file: *const libc::c_char,
                                  mut line: libc::c_int) -> () {
    use std::ffi::CStr;

    eprintln!("Fatal (internal) error in {}, line {}: {}",
              CStr::from_ptr(file).to_string_lossy(), line,
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn speex_resampler_set_rate_frac(mut st:
                                                           *mut SpeexResamplerState,
                                                       mut ratio_num:
                                                           spx_uint32_t,
                                                       mut ratio_den:
 ...
 -> libc::c_int {
    ...
    if ratio_num == 0i32 as libc::c_uint || ratio_den == 0i32 as libc::c_uint
       {
    ...
    } else if (*st).in_rate == in_rate && (*st).out_rate == out_rate &&
        ...
        (*st).num_rate =
            ((*st).num_rate as libc::c_uint).wrapping_div(fact) as
                spx_uint32_t as spx_uint32_t;
        (*st).den_rate =
            ((*st).den_rate as libc::c_uint).wrapping_div(fact) as
                spx_uint32_t as spx_uint32_t;
        if old_den > 0i32 as libc::c_uint {
            i = 0i32 as spx_uint32_t;
            while i < (*st).nb_channels {
                if _muldiv(&mut *(*st).samp_frac_num.offset(i as isize) as
                               *mut spx_uint32_t,
        ...
        } else { return RESAMPLER_ERR_SUCCESS as libc::c_int }
    };
}
unsafe extern "C" fn _gcd(mut a: spx_uint32_t, mut b: spx_uint32_t)
 -> spx_uint32_t {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn speex_resampler_set_quality(mut st:
                                                         *mut SpeexResamplerState,
                                                     mut quality: libc::c_int)
 -> libc::c_int {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn speex_resampler_process_float(mut st:
                                                           *mut SpeexResamplerState,
                                                       mut channel_index:
                                                           spx_uint32_t,
                                                       mut in_0:
 ...
 -> libc::c_int {
    ...
    let mut x: *mut spx_word16_t =
        (*st).mem.offset(channel_index.wrapping_mul((*st).mem_alloc_size) as
                             isize);
    ...
    if 0 != *(*st).magic_samples.offset(channel_index as isize) {
        olen =
            (olen as
                 libc::c_uint).wrapping_sub(speex_resampler_magic(st,
                                                                  channel_index,
                                                                  &mut out as
                                                                      *mut *mut libc::c_float,
                                                                  olen) as
                                                libc::c_uint) as spx_uint32_t
                as spx_uint32_t
    }
    if 0 == *(*st).magic_samples.offset(channel_index as isize) {
        while 0 != ilen && 0 != olen {
            ...
            ilen =
                (ilen as libc::c_uint).wrapping_sub(ichunk) as spx_uint32_t as
                    spx_uint32_t;
            olen =
                (olen as libc::c_uint).wrapping_sub(ochunk) as spx_uint32_t as
                    spx_uint32_t;
            out =
                out.offset(ochunk.wrapping_mul((*st).out_stride as
                                                   libc::c_uint) as isize);
            if in_0.is_null() { continue ; }
            in_0 =
                in_0.offset(ichunk.wrapping_mul(istride as libc::c_uint) as
                                isize)
        }
    }
    *in_len =
        (*in_len as libc::c_uint).wrapping_sub(ilen) as spx_uint32_t as
            spx_uint32_t;
    *out_len =
        (*out_len as libc::c_uint).wrapping_sub(olen) as spx_uint32_t as
            spx_uint32_t;
    return if (*st).resampler_ptr == Some(resampler_basic_zero) {
               RESAMPLER_ERR_ALLOC_FAILED as libc::c_int
           } else { RESAMPLER_ERR_SUCCESS as libc::c_int };
}
unsafe extern "C" fn speex_resampler_process_native(mut st:
                                                        *mut SpeexResamplerState,
                                                    mut channel_index:
                                                        spx_uint32_t,
                                                    mut in_len:
 ...
 -> libc::c_int {
    ...
    (*st).started = 1i32;
    out_sample =
        (*st).resampler_ptr.expect("non-null function pointer")(st,
                                                                channel_index,
                                                                mem, in_len,
                                                                out, out_len);
    ...
    *fresh9 =
        (*fresh9 as libc::c_uint).wrapping_sub(*in_len) as spx_int32_t as
            spx_int32_t;
    ilen = *in_len;
    j = 0i32;
    while j < N - 1i32 {
...
unsafe extern "C" fn speex_resampler_magic(mut st: *mut SpeexResamplerState,
                                           mut channel_index: spx_uint32_t,
 ...
 -> libc::c_int {
    ...
    let N: libc::c_int = (*st).filt_len as libc::c_int;
    speex_resampler_process_native(st, channel_index,
                                   &mut tmp_in_len as *mut spx_uint32_t, *out,
                                   &mut out_len as *mut spx_uint32_t);
    let ref mut fresh10 = *(*st).magic_samples.offset(channel_index as isize);
    *fresh10 =
        (*fresh10 as libc::c_uint).wrapping_sub(tmp_in_len) as spx_uint32_t as
            spx_uint32_t;
    if 0 != *(*st).magic_samples.offset(channel_index as isize) {
        let mut i: spx_uint32_t = 0;
        i = 0i32 as spx_uint32_t;
        while i < *(*st).magic_samples.offset(channel_index as isize) {
            *mem.offset(((N - 1i32) as libc::c_uint).wrapping_add(i) as isize)
                =
                *mem.offset(((N - 1i32) as
                                 libc::c_uint).wrapping_add(i).wrapping_add(tmp_in_len)
                                as isize);
            i = i.wrapping_add(1)
        }
    }
    *out =
        (*out).offset(out_len.wrapping_mul((*st).out_stride as libc::c_uint)
                          as isize);
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn speex_resampler_process_int(mut st:
                                                         *mut SpeexResamplerState,
                                                     mut channel_index:
                                                         spx_uint32_t,
                                                     mut in_0:
 ...
 -> libc::c_int {
    ...
    let mut x: *mut spx_word16_t =
        (*st).mem.offset(channel_index.wrapping_mul((*st).mem_alloc_size) as
                             isize);
    let xlen: spx_uint32_t =
        (*st).mem_alloc_size.wrapping_sub((*st).filt_len.wrapping_sub(1i32 as
                                                                          libc::c_uint));
    let ylen: libc::c_uint =
        if olen < 8192i32 as libc::c_uint {
            olen
        } else { 8192i32 as libc::c_uint };
    ...
    while 0 != ilen && 0 != olen {
        ...
        if 0 != *(*st).magic_samples.offset(channel_index as isize) {
            omagic =
                speex_resampler_magic(st, channel_index,
                                      &mut y as *mut *mut spx_word16_t,
                                      ochunk) as spx_uint32_t;
            ochunk =
                (ochunk as libc::c_uint).wrapping_sub(omagic) as spx_uint32_t
                    as spx_uint32_t;
            olen =
                (olen as libc::c_uint).wrapping_sub(omagic) as spx_uint32_t as
                    spx_uint32_t
        }
        if 0 == *(*st).magic_samples.offset(channel_index as isize) {
            if !in_0.is_null() {
                ...
                while (j as libc::c_uint) < ichunk {
                    *x.offset((j as
                                   libc::c_uint).wrapping_add((*st).filt_len).wrapping_sub(1i32
                                                                                               as
                                                                                               libc::c_uint)
                                  as isize) =
                        *in_0.offset((j * istride_save) as isize) as
                            spx_word16_t;
                    j += 1
                }
            } else {
        ...
        while (j as libc::c_uint) < ochunk.wrapping_add(omagic) {
            *out.offset((j * ostride_save) as isize) =
                (if *ystack.as_mut_ptr().offset(j as isize) < -32767.5f32 {
                     -32768i32
                 } else if *ystack.as_mut_ptr().offset(j as isize) >
                               32766.5f32 {
                     32767i32
                 } else {
                     floor(0.5f64 +
        ...
        olen =
            (olen as libc::c_uint).wrapping_sub(ochunk) as spx_uint32_t as
                spx_uint32_t;
        out =
            out.offset(ochunk.wrapping_add(omagic).wrapping_mul(ostride_save
                                                                    as
                                                                    libc::c_uint)
                           as isize);
        if in_0.is_null() { continue ; }
        in_0 =
            in_0.offset(ichunk.wrapping_mul(istride_save as libc::c_uint) as
                            isize)
    }
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn speex_resampler_process_interleaved_float(mut st:
                                                                       *mut SpeexResamplerState,
                                                                   mut in_0:
                                                                       *const libc::c_float,
                                                                   mut in_len:
 ...
 -> libc::c_int {
    ...
    while i < (*st).nb_channels {
        ...
        *in_len = bak_in_len;
        if !in_0.is_null() {
            speex_resampler_process_float(st, i, in_0.offset(i as isize),
                                          in_len, out.offset(i as isize),
                                          out_len);
        } else {
            speex_resampler_process_float(st, i, 0 as *const libc::c_float,
                                          in_len, out.offset(i as isize),
                                          out_len);
        }
        i = i.wrapping_add(1)
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn speex_resampler_process_interleaved_int(mut st:
                                                                     *mut SpeexResamplerState,
                                                                 mut in_0:
                                                                     *const spx_int16_t,
                                                                 mut in_len:
 ...
 -> libc::c_int {
    ...
    while i < (*st).nb_channels {
        ...
        *in_len = bak_in_len;
        if !in_0.is_null() {
            speex_resampler_process_int(st, i, in_0.offset(i as isize),
                                        in_len, out.offset(i as isize),
                                        out_len);
        } else {
            speex_resampler_process_int(st, i, 0 as *const spx_int16_t,
                                        in_len, out.offset(i as isize),
                                        out_len);
        }
        i = i.wrapping_add(1)
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn speex_resampler_set_rate(mut st:
                                                      *mut SpeexResamplerState,
                                                  mut in_rate: spx_uint32_t,
                                                  mut out_rate: spx_uint32_t)
 -> libc::c_int {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn speex_resampler_get_rate(mut st:
                                                      *mut SpeexResamplerState,
                                                  mut in_rate:
                                                      *mut spx_uint32_t,
                                                  mut out_rate:
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn speex_resampler_get_ratio(mut st:
                                                       *mut SpeexResamplerState,
                                                   mut ratio_num:
                                                       *mut spx_uint32_t,
                                                   mut ratio_den:
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn speex_resampler_get_quality(mut st:
                                                         *mut SpeexResamplerState,
                                                     mut quality:
                                                         *mut libc::c_int)
 -> () {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn speex_resampler_set_input_stride(mut st:
                                                              *mut SpeexResamplerState,
                                                          mut stride:
                                                              spx_uint32_t)
 -> () {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn speex_resampler_get_input_stride(mut st:
                                                              *mut SpeexResamplerState,
                                                          mut stride:
                                                              *mut spx_uint32_t)
 -> () {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn speex_resampler_set_output_stride(mut st:
                                                               *mut SpeexResamplerState,
                                                           mut stride:
                                                               spx_uint32_t)
 -> () {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn speex_resampler_get_output_stride(mut st:
                                                               *mut SpeexResamplerState,
                                                           mut stride:
                                                               *mut spx_uint32_t)
 -> () {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn speex_resampler_get_input_latency(mut st:
                                                               *mut SpeexResamplerState)
 -> libc::c_int {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn speex_resampler_get_output_latency(mut st:
                                                                *mut SpeexResamplerState)
 -> libc::c_int {
    return (*st).filt_len.wrapping_div(2i32 as
                                           libc::c_uint).wrapping_mul((*st).den_rate).wrapping_add((*st).num_rate
                                                                                                       >>
                                                                                                       1i32).wrapping_div((*st).num_rate)
               as libc::c_int;
}
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn speex_resampler_skip_zeros(mut st:
                                                        *mut SpeexResamplerState)
 -> libc::c_int {
    let mut i: spx_uint32_t = 0;
    i = 0i32 as spx_uint32_t;
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn speex_resampler_reset_mem(mut st:
                                                       *mut SpeexResamplerState)
 -> libc::c_int {
    let mut i: spx_uint32_t = 0;
    i = 0i32 as spx_uint32_t;
    ...
    i = 0i32 as spx_uint32_t;
    while i <
              (*st).nb_channels.wrapping_mul((*st).filt_len.wrapping_sub(1i32
                                                                             as
                                                                             libc::c_uint))
          {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn speex_resampler_strerror(mut err: libc::c_int)
 -> *const libc::c_char {
    match err {
        0 => {
            return (*::std::mem::transmute::<&[u8; 9],
                                             &mut [libc::c_char; 9]>(b"Success.\x00")).as_mut_ptr()
        }
        1 => {
            return (*::std::mem::transmute::<&[u8; 26],
                                             &mut [libc::c_char; 26]>(b"Memory allocation failed.\x00")).as_mut_ptr()
        }
        2 => {
            return (*::std::mem::transmute::<&[u8; 21],
                                             &mut [libc::c_char; 21]>(b"Bad resampler state.\x00")).as_mut_ptr()
        }
        3 => {
            return (*::std::mem::transmute::<&[u8; 18],
                                             &mut [libc::c_char; 18]>(b"Invalid argument.\x00")).as_mut_ptr()
        }
        4 => {
            return (*::std::mem::transmute::<&[u8; 34],
                                             &mut [libc::c_char; 34]>(b"Input and output buffers overlap.\x00")).as_mut_ptr()
        }
        _ => {
            return (*::std::mem::transmute::<&[u8; 59],
                                             &mut [libc::c_char; 59]>(b"Unknown error. Bad error code or strange version mismatch.\x00")).as_mut_ptr()
        }
    };
}
...
unsafe extern "C" fn getchar_unlocked() -> libc::c_int {
    return if 0 !=
               ...
               let fresh12 = (*stdin)._IO_read_ptr;
               (*stdin)._IO_read_ptr = (*stdin)._IO_read_ptr.offset(1);
               *(fresh12 as *mut libc::c_uchar) as libc::c_int
           };
}
...
unsafe extern "C" fn fputc_unlocked(mut __c: libc::c_int,
    ...
    return if 0 !=
               ...
               let fresh14 = (*__stream)._IO_write_ptr;
               (*__stream)._IO_write_ptr =
                   (*__stream)._IO_write_ptr.offset(1);
               *fresh14 = __c as libc::c_char;
...
unsafe extern "C" fn putc_unlocked(mut __c: libc::c_int,
    ...
    return if 0 !=
               ...
               let fresh15 = (*__stream)._IO_write_ptr;
               (*__stream)._IO_write_ptr =
                   (*__stream)._IO_write_ptr.offset(1);
               *fresh15 = __c as libc::c_char;
...
unsafe extern "C" fn putchar_unlocked(mut __c: libc::c_int) -> libc::c_int {
    return if 0 !=
               ...
               let fresh16 = (*stdout)._IO_write_ptr;
               (*stdout)._IO_write_ptr = (*stdout)._IO_write_ptr.offset(1);
               *fresh16 = __c as libc::c_char;
...
unsafe extern "C" fn gnu_dev_major(mut __dev: __dev_t) -> libc::c_uint {
    ...
    __major = ((__dev & 1048320u32 as __dev_t) >> 8i32) as libc::c_uint;
    __major =
        (__major as libc::c_ulong |
             (__dev & 18446726481523507200u64) >> 32i32) as libc::c_uint;
    return __major;
}
unsafe extern "C" fn gnu_dev_minor(mut __dev: __dev_t) -> libc::c_uint {
    let mut __minor: libc::c_uint = 0;
    __minor = ((__dev & 255u32 as __dev_t) >> 0i32) as libc::c_uint;
    __minor =
        (__minor as libc::c_ulong | (__dev & 17592184995840u64) >> 12i32) as
            libc::c_uint;
    return __minor;
}
unsafe extern "C" fn gnu_dev_makedev(mut __major: libc::c_uint,
                                     mut __minor: libc::c_uint) -> __dev_t {
    let mut __dev: __dev_t = 0;
    __dev = ((__major & 4095u32) as __dev_t) << 8i32;
    __dev |= ((__major & 4294963200u32) as __dev_t) << 32i32;
    __dev |= ((__minor & 255u32) as __dev_t) << 0i32;
    __dev |= ((__minor & 4294967040u32) as __dev_t) << 12i32;
    return __dev;
}
...
unsafe extern "C" fn speex_alloc_scratch(mut size: libc::c_int)
 -> *mut libc::c_void {
    return calloc(size as libc::c_ulong, 1i32 as libc::c_ulong);
}
/* * Same as speex_free, except that the area is only needed inside a Speex call (might cause problem with wideband though) */
unsafe extern "C" fn speex_free_scratch(mut ptr: *mut libc::c_void) -> () {
    free(ptr);
}
unsafe extern "C" fn speex_warning(mut str: *const libc::c_char) -> () {
    fprintf(stderr,
            (*::std::mem::transmute::<&[u8; 13],
                                      &mut [libc::c_char; 13]>(b"warning: %s\n\x00")).as_mut_ptr(),
            str);
}
unsafe extern "C" fn speex_warning_int(mut str: *const libc::c_char,
                                       mut val: libc::c_int) -> () {
    fprintf(stderr,
            (*::std::mem::transmute::<&[u8; 16],
                                      &mut [libc::c_char; 16]>(b"warning: %s %d\n\x00")).as_mut_ptr(),
            str, val);
}
unsafe extern "C" fn speex_notify(mut str: *const libc::c_char) -> () {
    fprintf(stderr,
            (*::std::mem::transmute::<&[u8; 18],
                                      &mut [libc::c_char; 18]>(b"notification: %s\n\x00")).as_mut_ptr(),
            str);
}
/* * Speex wrapper for putc */
unsafe extern "C" fn _speex_putc(mut ch: libc::c_int,
                                 mut file: *mut libc::c_void) -> () {
    let mut f: *mut FILE = file as *mut FILE;
    fprintf(f,
            (*::std::mem::transmute::<&[u8; 3],
                                      &mut [libc::c_char; 3]>(b"%c\x00")).as_mut_ptr(),
            ch);
}
unsafe extern "C" fn print_vec(mut vec: *mut libc::c_float,
                               mut len: libc::c_int,
                               mut name: *mut libc::c_char) -> () {
    let mut i: libc::c_int = 0;
    printf((*::std::mem::transmute::<&[u8; 4],
                                     &mut [libc::c_char; 4]>(b"%s \x00")).as_mut_ptr(),
           name);
    i = 0i32;
    while i < len {
        printf((*::std::mem::transmute::<&[u8; 4],
                                         &mut [libc::c_char; 4]>(b" %f\x00")).as_mut_ptr(),
               *vec.offset(i as isize) as libc::c_double);
        i += 1
    }
    printf((*::std::mem::transmute::<&[u8; 2],
                                     &mut [libc::c_char; 2]>(b"\n\x00")).as_mut_ptr());
}
unsafe extern "C" fn __signbitl(mut __x: libc::c_double) -> libc::c_int {
    let mut __u: unnamed_0 = unnamed_0{__l: __x,};
    return (__u.__i[2usize] & 32768i32 != 0i32) as libc::c_int;
}
