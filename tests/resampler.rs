...
fn resampling() {
    ...
    for &_ref_out in REFERENCE {
        ...
        let (in_len_native, out_len_native) = st_native.process_float(0, &fin[off .. off + in_len], &mut fout_native[..out_len]).unwrap();
        ...
        assert_eq!(&fout[..out_len as usize], &fout_native[..out_len as usize]);
