...
mod tests {
    ...
    fn drftf1() {
        #[rustfmt::skip]
        const INPUT: [f32; 64] = [
            0.015625, 0.031234406, 0.044264406, 0.053104334, 0.056647792, 0.05444269, 0.046751656,
            0.03451468, 0.01921964, 0.0026996145, -0.013113926, -0.026446797, -0.035910778,
            -0.04067359, -0.040547498, -0.035985842, -0.027990494, -0.017945888, -0.007405535,
            0.0021365732, 0.0094558755, 0.013758546, 0.014771932, 0.012753098, 0.00841726,
            0.002799591, -0.0029261513, -0.0076430514, -0.010469398, -0.010893257, -0.0088426825,
            -0.0046831034, 0.0008567027, 0.006815833, 0.01216773, 0.015994253, 0.017638927,
            0.01681492, 0.013650277, 0.008664127, 0.0026776828, -0.0033245152, -0.008360821,
            -0.011617917, -0.012589402, -0.011163228, -0.0076443525, -0.0027075065, 0.0027123645,
            0.0075756884, 0.010913619, 0.011996655, 0.010466794, 0.006412482, 0.000371797,
            -0.0067382287, -0.013756886, -0.019459356, -0.022754181, -0.022867028, -0.01948126,
            -0.012812861, -0.0036047082, 0.0069609154
        ];
        ...
        let mut trigcache = [0. as c_float; INPUT.len() * 3];
        let mut splitcache = [0 as c_int; 32];
